...
- **M0 — foundation:** establish governance, target-layout markers, migration
  ...
  truth.
- **M1 — history-preserving imports:** Dashboard import is **active**;
  import Dashboard into `apps/dashboard` while retaining practical history and
  compatibility entry points. Niu Men is the next separate PR.
